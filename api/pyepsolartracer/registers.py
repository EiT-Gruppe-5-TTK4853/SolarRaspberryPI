...
class Register:
    ...
    def __str__(self):
        return str(
            {"address": ("0x%x" % self.address), "name": self.name, "size": self.size}
        )
...
registers = [
    ...
    Register(
        "Charging equipment rated output voltage", 0x3004, "Battery's voltage", V, 100
    ),
    ...
    # Charging mode
    Register("Charging mode", 0x3008, "0001H-PWM", I, 1),
    # Rated output current of load
    Register(
        "Rated output current of load", 0x300E, "Rated output current of load", A, 100
    ),
    # Real-time data (read only) input register
    # Charging equipment input voltage
    Register(
        "solar_voltage", 0x3100, "Solar charge controller--PV array voltage", V, 100
    ),
    ...
    Register("battery_voltage", 0x3104, "Battery voltage", V, 100),
    # Charging equipment output current
    Register("battery_current", 0x3105, "Battery charging current", A, 100),
    # Charging equipment output power
    Register(
        "Charging equipment output power", 0x3106, "Battery charging power", W, 100, 2
    ),
    # Charging equipment output power L
    Register(
        "Charging equipment output power L", 0x3106, "Battery charging power", W, 100
    ),
    ...
    Register("load_voltage", 0x310C, "Load voltage", V, 100),
    # Discharging equipment output current
    Register("load_current", 0x310D, "Load current", A, 100),
    # Discharging equipment output power
    Register("Discharging equipment output power", 0x310E, "Load power", W, 100, 2),
    # Discharging equipment output power L
    Register("Discharging equipment output power L", 0x310E, "Load power L", W, 100),
    ...
    # Battery Temperature
    Register("battery_temp", 0x3110, "Battery Temperature", C, 100),
    # Temperature inside equipment
    Register("Temperature inside equipment", 0x3111, "Temperature inside case", C, 100),
    ...
    # Battery SOC
    Register(
        "Battery SOC", 0x311A, "The percentage of battery's remaining capacity", PC, 1
    ),
    # Remote battery temperature
    Register(
        "Remote battery temperature",
        0x311B,
        "The battery tempeture measured by remote temperature sensor",
        C,
        100,
    ),
    ...
    Register(
        "Battery's real rated power",
        0x311D,
        "Current system rated votlage. 1200, 2400 represent 12V, 24V",
        V,
        100,
    ),
    ...
    Register(
        "Maximum input volt (PV) today", 0x3300, "00: 00 Refresh every day", V, 100
    ),
    # Minimum input volt (PV) today
    Register(
        "Minimum input volt (PV) today", 0x3301, "00: 00 Refresh every day", V, 100
    ),
    # Maximum battery volt today
    Register("Maximum battery volt today", 0x3302, "00: 00 Refresh every day", V, 100),
    # Minimum battery volt today
    Register("Minimum battery volt today", 0x3303, "00: 00 Refresh every day", V, 100),
    # Consumed energy today
    Register("Consumed energy today", 0x3304, "00: 00 Clear every day", KWH, 100, 2),
    # Consumed energy today L
    Register("Consumed energy today L", 0x3304, "00: 00 Clear every day", KWH, 100),
    # Consumed energy today H
    Register("Consumed energy today H", 0x3305, "Consumed energy today H", KWH, 100),
    # Consumed energy this month
    Register(
        "Consumed energy this month",
        0x3306,
        "00: 00 Clear on the first day of month",
        KWH,
        100,
        2,
    ),
    ...
    Register(
        "Consumed energy this month H", 0x3307, "Consumed energy this month H", KWH, 100
    ),
    # Consumed energy this year
    Register(
        "Consumed energy this year", 0x3308, "00: 00 Clear on 1, Jan.", KWH, 100, 2
    ),
    # Consumed energy this year L
    Register(
        "Consumed energy this year L", 0x3308, "00: 00 Clear on 1, Jan.", KWH, 100
    ),
    # Consumed energy this year H
    Register(
        "Consumed energy this year H", 0x3309, "Consumed energy this year H", KWH, 100
    ),
    # Total consumed energy
    Register("Total consumed energy", 0x330A, "Total consumed energy", KWH, 100, 2),
    # Total consumed energy L
    Register("Total consumed energy L", 0x330A, "Total consumed energy L", KWH, 100),
    # Total consumed energy H
    Register("Total consumed energy H", 0x330B, "Total consumed energy H", KWH, 100),
    # Generated energy today
    Register("Generated energy today", 0x330C, "00: 00 Clear every day.", KWH, 100, 2),
    # Generated energy today L
    Register("Generated energy today L", 0x330C, "00: 00 Clear every day.", KWH, 100),
    # Generated energy today H
    Register("Generated energy today H", 0x330D, "Generated energy today H", KWH, 100),
    ...
    Register(
        "Generated energy this year", 0x3310, "00: 00 Clear on 1, Jan.", KWH, 100, 2
    ),
    # Generated energy this year L
    Register(
        "Generated energy this year L", 0x3310, "00: 00 Clear on 1, Jan.", KWH, 100
    ),
    # Generated energy this year H
    Register(
        "Generated energy this year H", 0x3311, "Generated energy this year H", KWH, 100
    ),
    # Total generated energy
    Register("Total generated energy", 0x3312, "Total generated energy", KWH, 100, 2),
    # Total generated energy L
    Register("Total generated energy L", 0x3312, "Total generated energy L", KWH, 100),
    # Total Generated energy H
    Register("Total Generated energy H", 0x3313, "Total Generated energy H", KWH, 100),
    ...
    Register(
        "Carbon dioxide reduction H", 0x3315, "Carbon dioxide reduction H", Ton, 100
    ),
    # Battery Current
    Register(
        "Battery Current",
    ...
    # Battery Current H
    Register("Battery Current H", 0x331C, "Battery Current H", A, 100),
    # Battery Temp.
    Register("Battery Temp.", 0x331D, "Battery Temp.", C, 100),
    # Ambient Temp.
    Register("Ambient Temp.", 0x331E, "Ambient Temp.", C, 100),
    ...
    # Battery Capacity
    Setting("Battery Capacity", 0x9001, "Rated capacity of the battery", AH, 1),
    # Temperature compensation coefficient
    Setting(
        "Temperature compensation coefficient", 0x9002, "Range 0-9 mV/�C/2V", I, 100
    ),
    # High Volt.disconnect
    Setting("High Volt.disconnect", 0x9003, "High Volt.disconnect", V, 100),
    # Charging limit voltage
    Setting("Charging limit voltage", 0x9004, "Charging limit voltage", V, 100),
    # Over voltage reconnect
    Setting("Over voltage reconnect", 0x9005, "Over voltage reconnect", V, 100),
    # Equalization voltage
    Setting("Equalization voltage", 0x9006, "Equalization voltage", V, 100),
    # Boost voltage
    Setting("Boost voltage", 0x9007, "Boost voltage", V, 100),
    # Float voltage
    Setting("Float voltage", 0x9008, "Float voltage", V, 100),
    # Boost reconnect voltage
    Setting("Boost reconnect voltage", 0x9009, "Boost reconnect voltage", V, 100),
    # Low voltage reconnect
    Setting("Low voltage reconnect", 0x900A, "Low voltage reconnect", V, 100),
    # Under voltage recover
    Setting("Under voltage recover", 0x900B, "Under voltage recover", V, 100),
    # Under voltage warning
    Setting("Under voltage warning", 0x900C, "Under voltage warning", V, 100),
    # Low voltage disconnect
    Setting("Low voltage disconnect", 0x900D, "Low voltage disconnect", V, 100),
    # Discharging limit voltage
    Setting("Discharging limit voltage", 0x900E, "Discharging limit voltage", V, 100),
    # Real time clock
    Setting(
        "Real time clock",
        0x9013,
        "D7-0 Sec, D15-8 Min. D23-16 Hour, D31-24 Day D39-32 Month, D49-40 Year",
        WORDS,
        1,
        3,
    ),
    ...
    # Real time clock 2
    Setting("Real time clock 2", 0x9014, "D7-0 Hour, D15-8 Day", I, 1),
    # Real time clock 3
    Setting("Real time clock 3", 0x9015, "D7-0 Month, D15-8 Year", I, 1),
    ...
    # Line Impedance
    Setting(
        "Line Impedance", 0x901D, "The resistance of the connectted wires.", MO, 100
    ),
    ...
    Setting(
        "Working time length 1",
        0x903E,
        "The length of load output timer1, D15-D8,hour, D7-D0, minute",
        I,
        1,
    ),
    ...
    Setting("Turn on timing 1 sec", 0x9042, "Turn on timing 1 sec", SEC, 1),
    # Turn on timing 1 min
    Setting("Turn on timing 1 min", 0x9043, "Turn on timing 1 min", MIN, 1),
    # Turn on timing 1 hour
    Setting("Turn on timing 1 hour", 0x9044, "Turn on timing 1 hour", HOUR, 1),
    # Turn off timing 1 sec
    Setting("Turn off timing 1 sec", 0x9045, "Turn off timing 1 sec", SEC, 1),
    # Turn off timing 1 min
    Setting("Turn off timing 1 min", 0x9046, "Turn off timing 1 min", MIN, 1),
    # Turn off timing  hour
    Setting("Turn off timing 1 hour", 0x9047, "Turn off timing 1 hour", HOUR, 1),
    # Turn on timing 2 sec
    Setting("Turn on timing 2 sec", 0x9048, "Turn on timing 2 sec", SEC, 1),
    # Turn on timing 2 min
    Setting("Turn on timing 2 min", 0x9049, "Turn on timing 2 min", MIN, 1),
    # Turn on timing 2 hour
    Setting("Turn on timing 2 hour", 0x904A, "Turn on timing 2 hour", HOUR, 1),
    # Turn off timing 2 sec
    Setting("Turn off timing 2 sec", 0x904B, "Turn off timing 2 sec", SEC, 1),
    # Turn off timing 2 min
    Setting("Turn off timing 2 min", 0x904C, "Turn off timing 2 min", MIN, 1),
    # Turn off timing 2 hour
    Setting("Turn off timing 2 hour", 0x904D, "Turn off timing 2 hour", HOUR, 1),
    # Length of night
    Setting(
        "Length of night",
        0x9065,
    ...
    Setting(
        "Battery rated voltage code", 0x9067, "0, auto recognize. 1-12V, 2-24V", I, 1
    ),
    ...
    Setting("Default Load On/Off in manual mode", 0x906A, "0-off, 1-on", I, 1),
    # Equalize duration
    Setting("Equalize duration", 0x906B, "Usually 60-120 minutes.", MIN, 1),
    # Boost duration
    Setting("Boost duration", 0x906C, "Usually 60-120 minutes.", MIN, 1),
    ...
    # Charging percentage
    Setting("Charging percentage", 0x906E, "Depth of charge, 20%-100%.", PC, 1),
    # 906f?
...
coils = [
    ...
    Coil("Enable load test mode", 5, "1 Enable, 0 Disable(normal)", I, 1),
    ...
    # Day/Night
    Coil("Day/Night", 0x200C, "1-Night, 0-Day", I, 1),
]
